...
from denmark.core.model import get_model_logits, load_generator_model, resolve_mask_id, safe_decode
from denmark.baselines.clean.generate import (
    DATASETS,
    build_prompt,
    clean_text,
    load_rows,
        ...
        with output.open("w", encoding="utf-8") as handle:
            for source_idx, record in tqdm(selected, desc=dataset):
                ...
                if args.generator_family == "dream":
                    from denmark.baselines.clean.model import build_prompt as build_dream_prompt
                    from denmark.core.model import (build_model_input_from_row)
