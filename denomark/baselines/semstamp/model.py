...
Unlike :mod:`denomark.baselines.block_best_of_k.model`, no candidate is selected because it
...
from denomark.baselines.block_best_of_k.model import _sample_candidate_microbatch
from denomark.core.scoring import block_decode
from denomark.core.model import encode_texts, safe_decode
