...
def main() -> None:
    ...
    from denomark.baselines.dgmark.model import (
        DGMarkLogitsBias,
    ...
    if args.generator_family == "dream":
        from denomark.baselines.clean.model import (
            build_prompt as build_dream_origin_prompt,
            dream_origin_diffusion_generate,
        )
        from denomark.core.model import (build_model_input_from_row, safe_decode_dream as dream_safe_decode)
