...
from denomark.core.generate import build_candidates_random_positions, deduplicate_candidates
from denomark.experiments.trajectory.llada_cumulative_metrics import (
    full_k_theorem_metrics,
    prefix_rollout_metrics,
)
from denomark.core.model import build_directions, encode_texts, resolve_mask_id
R_VALUES = (1, 3, 5, 10)
