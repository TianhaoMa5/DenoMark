...
from denomark.baselines.dgmark.model import llada_generate_dgmark
from denomark.core.generate import build_directions, generate_one
from denomark.baselines.dlm_kgw.model import HashDistribution, llada_generate_hash_distribution
from denomark.core.model import load_generator_model, resolve_mask_id, safe_decode
from denomark.experiments.downstream.tasks import (
    BENCHMARKS,
    MODEL_DEFAULTS,
    TASK_SETTINGS,
    build_prompt,
...
from denomark.baselines.patternmark.generate import (
    INITIAL_STATE,
    PATTERNS,
    TRANSITION_MATRIX,
...
def load_components(args: argparse.Namespace):
    ...
    if args.method == "umr":
        ...
        from denomark.baselines.umr.generate import install_llada_gumbel_score_compat
