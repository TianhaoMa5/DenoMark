"""DenoMark generation for diffusion language models such as LLaDA.
...
CLI:
  python -m denomark.core.generate \
...
from denomark.core.selectors import select_candidate
...
def main():
    ...
    if family.generator_family == "dream":
        from denomark.core.model import generate_dream
